...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        if ((truth in model_label) or (set(truth.split(' ')) == (set(model_label.split(' '))))):
            results_dic[key] = [truth, model_label, 1, 0, 0]
        ...
        clasified_items += 1
        print(clasified_items, '/', total_items)